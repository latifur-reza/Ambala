...
import inn.ambala.reports.controller.ConferenceBookingJR;
 ...
 * @author REZA
 */
public class ConferenceBookingsReport extends javax.swing.JFrame {

    private DefaultTableModel model = null;
    Date from;
    Date to;
    /**
     * Creates new form ConferenceBookings
     */
    public ConferenceBookingsReport() {
        initComponents();
        initExtraComponents();
    }
    
    public ConferenceBookingsReport(Date from, Date to) {
        this.from = from;
        this.to = to;
        initComponents();
        initExtraComponents();
    ...
    private void refreshTable(){
        ArrayList<BookingDetailsModel> allBookings = BookingDetailsCrud.getBookingDetailsByDate(from, to);
        ...
        for(BookingDetailsModel bdm : allBookings){
            for(PaymentDetailsModel pdm : allPayments){
                if(bdm.getVoucherNo().equals(pdm.getVoucharNo())){
                    model.addRow(new Object[]{bdm.getVoucherNo(),bdm.getCompany(),bdm.getFrom(),bdm.getTo(),bdm.getStatus(),pdm.getTotal()});
                }
            }
    ...
    private void printButtonPressed(){
        try{
            new ConferenceBookingJR(from, to).setVisible(true);
        }catch(Exception e){
    ...
    private void initComponents() {
        ...
        dataTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Vouchar No.", "Company", "Time From", "Time To", "Status", "Total Bill"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConferenceBookingsReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConferenceBookingsReport().setVisible(true);
            }
        });
    }
