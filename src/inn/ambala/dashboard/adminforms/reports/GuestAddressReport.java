...
import inn.ambala.reports.controller.GuestAddressJR;
 ...
 * @author REZA
 */
public class GuestAddressReport extends javax.swing.JFrame {

    private DefaultTableModel model = null;
    Date from;
    Date to;
    /**
     * Creates new form GuestAddressReport
     */
    public GuestAddressReport() {
        initComponents();
        initExtraComponents();
    }
    
    public GuestAddressReport(Date from, Date to) {
        this.from = from;
        this.to = to;
        initComponents();
        initExtraComponents();
    ...
    private void printButtonPressed(){
        try{
            new GuestAddressJR(from, to).setVisible(true);
        }catch(Exception e){
    ...
    private void initComponents() {
        ...
        addressLabel.setText("Guest Address");
        ...
        dataTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mr No", "Name", "Address", "Arrival Date"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GuestAddressReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GuestAddressReport().setVisible(true);
            }
        });
    }
