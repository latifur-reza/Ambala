...
import inn.ambala.deleteforms.Delete;
...
public class DeleteDashboard extends javax.swing.JFrame {
    ...
    public DeleteDashboard(String userName) {
    ...
    private void initComponents() {
        ...
        deletePanel.setBackground(new java.awt.Color(101, 45, 144));
    ...
    private void deletePanelMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deletePanelMouseEntered
        // TODO add your handling code here:
        deletePanel.setBackground(mouseEntry);
    ...
    private void deletePanelMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deletePanelMouseExited
        if(selection != 10){
            deletePanel.setBackground(mouseExit);
        }
