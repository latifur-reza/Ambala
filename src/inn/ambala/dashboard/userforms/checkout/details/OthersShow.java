 ...
 * @author REZA
 */
public class OthersShow extends javax.swing.JFrame {

    private static DefaultTableModel model = null;
    String mrNo;
    /**
     * Creates new form OthersShow
     */
    public OthersShow() {
        initComponents();
        initExtraComponents();
    ...
    public void refreshTable(String mrNo) {
        new OthersAddCrud(model).showAllOthers(mrNo);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OthersShow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OthersShow().setVisible(true);
            }
        });
    }
