...
import inn.ambala.dashboard.userforms.addforms.LaundryAdd;
import inn.ambala.dashboard.userforms.extraforms.LaundryItems;
import inn.ambala.dashboard.userforms.extraforms.LaundryOrders;
import inn.ambala.dashboard.userforms.model.UserInfoModel;
import inn.ambala.dashboard.userforms.model.UsersRoomInfoModel;
import inn.ambala.dashboard.userforms.print.LaundryPrint;
...
public class Laundry extends javax.swing.JPanel {
    ...
    public static void refreshTable(String mrNo, String status) {
        new LaundryAddCrud(model).showAllLaundry(mrNo, status);
        showCurrentCheckIns();
    }
    ...
    private void addNewButtonPressed(){
        if(roomNoTF.getText().equals("") || mrNoTF.getText().equals("")){
            ...
            try{
                LaundryAdd laundryAdd = new LaundryAdd(Integer.valueOf(roomNoTF.getText()), mrNoTF.getText());
                laundryAdd.setVisible(true);
            }catch(Exception e){
    ...
    private void deleteButtonPressed(){
        ...
        if (rowNo != -1) {
            ...
            if (option == 0) {
                result = LaundryAddCrud.deleteLaundry(mrNos, laundryCode);
    ...
    private void doneButtonPressed(){
        ...
        try{
            ...
            dueTF.setText("");
            model.setRowCount(0);
            new LaundryPrint(mrNos, roomNo, totalBill, pay, totalBill-pay);
    ...
    private void totalTFAction(){
        ...
        for(int i = 0; i < dataTable.getRowCount(); i++){
            total = total +(int) dataTable.getModel().getValueAt(i, 5);
        }
    ...
    private void laundryItemsButtonPressed(){
        new LaundryItems().setVisible(true);
    }
    
    private void currentLaundryButtonPressed(){
    ...
    private void initComponents() {
        ...
        currentLaundryButton = new javax.swing.JButton();
        addNewButton = new javax.swing.JButton();
        totalTF = new javax.swing.JTextField();
        jLabel1 = new javax.swing.JLabel();
        laundryItemsButton = new javax.swing.JButton();
        ...
        currentLaundryButton.setBackground(new java.awt.Color(236, 0, 138));
        currentLaundryButton.setForeground(new java.awt.Color(255, 255, 255));
        currentLaundryButton.setText("Current Laundry");
        currentLaundryButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                currentLaundryButtonActionPerformed(evt);
            }
        });
        ...
        laundryItemsButton.setBackground(new java.awt.Color(59, 180, 74));
        laundryItemsButton.setForeground(new java.awt.Color(255, 255, 255));
        laundryItemsButton.setText("Laundry Items");
        laundryItemsButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                laundryItemsButtonActionPerformed(evt);
            }
        });
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(laundryItemsButton)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(currentLaundryButton)
    ...
    private void currentLaundryButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_currentLaundryButtonActionPerformed
        currentLaundryButtonPressed();
    }//GEN-LAST:event_currentLaundryButtonActionPerformed
    ...
    private void laundryItemsButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_laundryItemsButtonActionPerformed
        laundryItemsButtonPressed();
    }//GEN-LAST:event_laundryItemsButtonActionPerformed
    ...
    private javax.swing.JButton currentLaundryButton;
    ...
    private javax.swing.JButton laundryItemsButton;
