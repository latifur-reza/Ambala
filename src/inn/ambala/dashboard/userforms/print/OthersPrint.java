 ...
 * @author REZA
 */
public class OthersPrint extends javax.swing.JFrame {
    ...
    private int due;
    /**
     * Creates new form OthersPrint
     */
    public OthersPrint() {
        initComponents();
    }
    
    public OthersPrint(String mrNo, int roomNo, int total, int pay, int due) {
    ...
    private void setData(){
        ...
        new OthersAddCrud(model).showAllOthersForPrint(mrNo);
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Others Receipt");
        ...
        contentPanelLayout.setHorizontalGroup(
            ...
            .addGroup(contentPanelLayout.createSequentialGroup()
                .addGroup(contentPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(contentPanelLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(dataTable, javax.swing.GroupLayout.PREFERRED_SIZE, 688, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OthersPrint.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OthersPrint().setVisible(true);
            }
        });
    }
