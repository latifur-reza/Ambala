 ...
 * @author REZA
 */
public class ConferenceBookingPrint extends javax.swing.JFrame {
     ...
     */
    public ConferenceBookingPrint() {
        initComponents();
    }
    
    public ConferenceBookingPrint(BookingDetailsModel bdm,AmountDetailsModel adm,PaymentDetailsModel pdm, int vat, int service) {
        this.bdm = bdm;
        this.adm = adm;
        this.pdm = pdm;
        this.vat = vat;
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Conference Booking");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConferenceBookingPrint.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConferenceBookingPrint().setVisible(true);
            }
        });
    }
