 ...
 * @author REZA
 */
public class AdvancePaymentPrint extends javax.swing.JFrame {

    private String mrNo;
    private int roomNo;
    private int payAmount;
    /**
     * Creates new form AdvancePaymentPrint
     */
    public AdvancePaymentPrint() {
        initComponents();
        initExtraComponents();
    }
    
    public AdvancePaymentPrint(String mrNo,int roomNo,int payAmount) {
        this.mrNo = mrNo;
        this.roomNo = roomNo;
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Advance Payment Receipt");
        ...
        jLabel22.setText("Advance Amount :");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdvancePaymentPrint.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdvancePaymentPrint().setVisible(true);
            }
        });
    }
