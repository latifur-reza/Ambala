 ...
 * @author REZA
 */
public class RestaurantPrint extends javax.swing.JFrame {
    ...
    private int due;
    /**
     * Creates new form RestaurantPrint
     */
    public RestaurantPrint() {
        initComponents();
    }
    
    public RestaurantPrint(String mrNo, int roomNo, int total, int pay, int due) {
    ...
    private void setData(){
        ...
        new RestaurantAddCrud(model).showAllRestaurantsForPrint(mrNo, "ordered");
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Restaurant Receipt");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RestaurantPrint.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RestaurantPrint().setVisible(true);
            }
        });
    }
