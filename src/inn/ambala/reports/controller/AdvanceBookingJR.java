 ...
 * @author REZA
 */
public class AdvanceBookingJR extends javax.swing.JFrame {

    private JPanel contentPanel;
    /**
     * Creates new form AdvanceBookingJR
     */
    public AdvanceBookingJR() {
        initComponents();
        initExtraComponents();
        readyReport();
    }
    ...
    public void readyReport(){
        ...
        try{
                        ...
                        if(urim.getMrNo().equals(uim.getMrNo())){
                            for(UserOthersInfoModel uoim : allUserOthersInfo){
                                if(urim.getMrNo().equals(uoim.getMrNo())){
                                    ...
                                    map.put("flight", uoim.getProbableStay());
                                    map.put("pickupfrom", uoim.getWhereIssued());
                                    dataSource.add(map);
                                }
                            }
                        }
            ...
            String sourceName = ReportSource.getPath() + "AdvanceBooking.jrxml";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdvanceBookingJR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
