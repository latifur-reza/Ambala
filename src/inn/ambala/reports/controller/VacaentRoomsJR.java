 ...
 * @author REZA
 */
public class VacaentRoomsJR extends javax.swing.JFrame {

    private JPanel contentPanel;
    /**
     * Creates new form Testing
     */
    public VacaentRoomsJR() {
        initComponents();
        initExtraComponents();
        readyReport();
    }
    ...
    public void readyReport(){
        ArrayList<RoomDetailsModel> allRooms = RoomDetailsCrud.getAllRooms();
        try{
            List<Map<String,?>> dataSource = new ArrayList<Map<String,?>>();
            for(RoomDetailsModel rdm : allRooms){
                Map<String, Object> map = new HashMap<String, Object>();
                if(rdm.getStatus().equals("CheckedOut")){
                    map.put("roomNo", rdm.getRoomNo());
                    dataSource.add(map);
                }
            }
            
            JRDataSource jrdataSource = new JRBeanCollectionDataSource(dataSource);
            String sourceName = ReportSource.getPath() + "VacaentRooms.jrxml";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VacaentRoomsJR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
