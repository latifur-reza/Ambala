 ...
 * @author REZA
 */
public class DailyGuestJR extends javax.swing.JFrame {

    private JPanel contentPanel;
    /**
     * Creates new form DailyGuestJR
     */
    public DailyGuestJR() {
        initComponents();
        initExtraComponents();
    ...
    public void readyReport(){
        ...
        try{
            ...
            String sourceName = ReportSource.getPath() + "DailyGuest.jrxml";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DailyGuestJR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
