 ...
 * @author REZA
 */
public class GuestDepositeJR extends javax.swing.JFrame {

    private JPanel contentPanel;
    /**
     * Creates new form GuestDepositeJR
     */
    public GuestDepositeJR() {
        initComponents();
        initExtraComponents();
        readyReport();
    }
    ...
    private void readyReport(){
        ...
        try{
                ...
                if(urim.getStatus().equals("CheckedIn")){
                    for(UserInfoModel uim : allUserInfo){
                        if(urim.getMrNo().equals(uim.getMrNo())){
                            ...
                            map.put("deposite", String.valueOf(paidBill));
                            dataSource.add(map);
                        }
                    }
                }
            ...
            String sourceName = ReportSource.getPath() + "GuestDeposite.jrxml";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GuestDepositeJR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
