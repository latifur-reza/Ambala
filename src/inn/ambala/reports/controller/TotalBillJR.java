 ...
 * @author REZA
 */
public class TotalBillJR extends javax.swing.JFrame {

    private JPanel contentPanel;
    private Date from;
    private Date to;
    /**
     * Creates new form TotalBillJR
     */
    public TotalBillJR() {
        initComponents();
        initExtraComponents();
    ...
    public TotalBillJR(Date from, Date to) {
        this.from = from;
        this.to = to;
        initComponents();
        initExtraComponents();
    ...
    public void readyReport(){
        ...
        try{
            ...
            for(Payment payment : allPayment){
                ...
                map.put("pays", String.valueOf(payment.getNetPayable()));
                total += payment.getNetPayable();
                dataSource.add(map);
            }
            Map<String, Object> map = new HashMap<String, Object>();
            map.put("total","Total Bill : " + String.valueOf(total));
            dataSource.add(map);
            
            JRDataSource jrdataSource = new JRBeanCollectionDataSource(dataSource);
            String sourceName = ReportSource.getPath() + "TotalBill.jrxml";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TotalBillJR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TotalBillJR().setVisible(true);
            }
        });
    }
