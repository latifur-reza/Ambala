 ...
 * @author REZA
 */
public class CompanyInfoJR extends javax.swing.JFrame {

    private JPanel contentPanel;
    /**
     * Creates new form CompanyInfoJR
     */
    public CompanyInfoJR() {
        initComponents();
        initExtraComponents();
        readyReport();
    }
    ...
    public void readyReport(){
        ...
        try{
            ...
            for(CompanyInfoModel cim : allCompany){
                ...
                map.put("code", String.valueOf(cim.getCompanyCode()));
                map.put("companyName", cim.getCompanyName());
                map.put("contactPerson", cim.getContactPerson());
                map.put("phone", cim.getPhone());
                map.put("email", cim.getEmail());
                map.put("address", cim.getAddress());
                map.put("mobile", cim.getMobile());
                map.put("balance", String.valueOf(cim.getBalance()));
                dataSource.add(map);
                
            }
            
            JRDataSource jrdataSource = new JRBeanCollectionDataSource(dataSource);
            String sourceName = ReportSource.getPath() + "CompanyInfo.jrxml";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CompanyInfoJR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
